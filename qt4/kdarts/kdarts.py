...
appName = "Kdarts"
catalog = ""
programName = ki18n("Kdarts")
version = "1.0"
description = ki18n("First PyKDE try")
license = KAboutData.License_GPL
copyright = ki18n("(c) 2008 MatteoSoftware")
text = ki18n("none")
homePage = "www.kubuntu.org"
bugEmail = "matteo.sani@cern.ch"
...
numero_giocatori = QInputDialog.getInteger (self.app, "Prova", "RiProva", 0, 1, 10)

print numero_giocatori
#setta punteggi iniziali
# entra nel loop per segnare i punteggi
# controlla il punteggio per la fine
