    ...
    if (s == 2)
    {
        ...
        if (ret == IDOK)
        {
            try
            {
                ...
                riga.nazione1 = edit[6]; riga.via2 = edit[7]; riga.citta2 = edit[8];
                riga.stato2 = edit[9]; riga.cap2 = edit[10]; riga.nazione2 = edit[11];
                riga.telefono = edit[12]; riga.cellulare = edit[13]; riga.email = edit[14];
                riga.carta = edit[15]; riga.iva = edit[16]; riga.note = edit[17];
                int limit = edit[17].length();
                if (edit[17].substr(0, 1) == "'")
                    edit[17].insert(0,"\\");
            
                for (int z=1; z<=limit; z++)
                {
                   
                    if ((edit[17].substr(z, 1) == "'") &&  (edit[17].substr(z-1, 1) != "\\"))
                        edit[17].insert(z,"\\");
                } 
                if ((edit[0] != "") && (edit[1] != ""))
                {        
    ...
    if (stato == 2)
    {
        ...
        if (ret == ID_APPLY)
        {
            try
            {
                ...
                riga.stato2 = edit[9]; riga.cap2 = edit[10]; riga.nazione2 = edit[11];
                riga.telefono = edit[12]; riga.cellulare = edit[13]; riga.email = edit[14];
                riga.carta = edit[15]; riga.iva = edit[16]; 
                int limit = edit[17].length();
                if (edit[17].substr(0, 1) == "'")
                    edit[17].insert(0,"\\");
