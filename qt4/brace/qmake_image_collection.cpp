/****************************************************************************
** Image collection for project 'brace'.
**
...
**      images/undo
**
** Created: Sat May 5 21:19:07 2007
...
static struct EmbedImage {
    ...
    { 22, 22, 32, (const unsigned char*)image_0_data, 123, 0, 0, TRUE, "editcopy" },
    { 22, 22, 32, (const unsigned char*)image_1_data, 102, 0, 0, TRUE, "editcut" },
    { 22, 22, 32, (const unsigned char*)image_2_data, 149, 0, 0, TRUE, "editpaste" },
    { 22, 22, 32, (const unsigned char*)image_3_data, 81, 0, 0, TRUE, "filenew" },
    { 22, 22, 32, (const unsigned char*)image_4_data, 114, 0, 0, TRUE, "fileopen" },
    { 22, 22, 32, (const unsigned char*)image_5_data, 98, 0, 0, TRUE, "filesave" },
    { 22, 22, 32, (const unsigned char*)image_6_data, 520, 0, 0, TRUE, "print" },
    { 22, 22, 32, (const unsigned char*)image_7_data, 90, 0, 0, TRUE, "redo" },
    { 22, 22, 32, (const unsigned char*)image_8_data, 480, 0, 0, TRUE, "searchfind" },
    { 22, 22, 32, (const unsigned char*)image_9_data, 86, 0, 0, TRUE, "undo" },
    { 0, 0, 0, 0, 0, 0, 0, 0, 0 }
};
...
class MimeSourceFactory_brace : public QMimeSourceFactory
{
public:
    MimeSourceFactory_brace() {}
    ~MimeSourceFactory_brace() {}
...
void qInitImages_brace()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_brace;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_brace()
{
    if ( factory ) {
...
class StaticInitImages_brace
{
public:
    StaticInitImages_brace() { qInitImages_brace(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_brace() { }
#else
    ~StaticInitImages_brace() { qCleanupImages_brace(); }
#endif
};

static StaticInitImages_brace staticImages;
