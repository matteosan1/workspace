/****************************************************************************
** Form implementation generated from reading ui file 'brace.ui'
**
** Created: Sun May 6 13:28:39 2007
...
/*
 *  Constructs a brace as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 */
brace::brace( QWidget* parent, const char* name, WFlags fl )
    : QMainWindow( parent, name, fl )
{
    ...
    editTavoloAction = new QAction( this, "editTavoloAction" );
    editPrenotazioneAction = new QAction( this, "editPrenotazioneAction" );
    ...
    editTavoloAction->addTo( editMenu );
    editPrenotazioneAction->addTo( editMenu );
    ...
    connect( editTavoloAction, SIGNAL( activated() ), this, SLOT( editTavolo() ) );
    connect( editPrenotazioneAction, SIGNAL( activated() ), this, SLOT( editPrenotazione() ) );
}
...
void brace::languageChange()
{
    ...
    editTavoloAction->setText( tr( "Tavolo" ) );
    editTavoloAction->setMenuText( tr( "Tavolo" ) );
    editPrenotazioneAction->setText( tr( "Prenotazione" ) );
    editPrenotazioneAction->setMenuText( tr( "Prenotazione" ) );
