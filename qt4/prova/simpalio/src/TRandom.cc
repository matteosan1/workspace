...
//  Return a number distributed following a BreitWigner function with mean and gamma
    ...
    double rval, displ;
    rval = 2*Rndm() - 1;
    displ = 0.5*gamma*tan(rval*3.14159265358979323846/2.0);
...
void TRandom::Circle(double &x, double &y, double r) {
    ...
    double phi = Uniform(0,3.14159265358979323846*2.0);
    x = r*cos(phi);
    y = r*sin(phi);
}
...
double TRandom::Exp(double tau) {
    ...
    double x = Uniform();       // uniform on ] 0, 1 ]
