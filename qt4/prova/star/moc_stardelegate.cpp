...
**
** Created: Sun Oct 14 13:14:50 2007
...
static const char qt_meta_stringdata_StarDelegate[] = {
    "StarDelegate\0\0commitAndCloseEditor()\0"
};

const QMetaObject StarDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_StarDelegate,
      qt_meta_data_StarDelegate, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StarDelegate))
